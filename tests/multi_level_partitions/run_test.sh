...
transparent_alter_type -t analytics.communication -c "id:bigint" --batch-size 100000 &
...
transparent_alter_type -t analytics.page -c "id:bigint" -j 4 --batch-size 100000 &
